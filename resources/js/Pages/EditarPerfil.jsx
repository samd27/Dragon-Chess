...
export default function EditarPerfil({ auth, stats }) {
    ...
    const guerrerosAvatars = [
        { name: 'Caulifla', path: '/images/characters/Guerreros/Alfil/caulifla.png', category: 'Guerreros Z' },
        { name: 'Hit', path: '/images/characters/Guerreros/Alfil/hit.png', category: 'Guerreros Z' },
        { name: 'Ten Shin Han', path: '/images/characters/Guerreros/Alfil/ten.png', category: 'Guerreros Z' },
        { name: 'Trunks', path: '/images/characters/Guerreros/Alfil/Trunks.png', category: 'Guerreros Z' },
        { name: 'Yamcha', path: '/images/characters/Guerreros/Alfil/yamcha.png', category: 'Guerreros Z' },
        { name: 'Gohan', path: '/images/characters/Guerreros/Caballo/gohan.png', category: 'Guerreros Z' },
        { name: 'Granola', path: '/images/characters/Guerreros/Caballo/granola.png', category: 'Guerreros Z' },
        { name: 'Kyabe', path: '/images/characters/Guerreros/Caballo/kyabe.png', category: 'Guerreros Z' },
        { name: 'Tapion', path: '/images/characters/Guerreros/Caballo/tapion.png', category: 'Guerreros Z' },
        { name: 'Vegeta', path: '/images/characters/Guerreros/Caballo/vegetta.png', category: 'Guerreros Z' },
        { name: 'Chaos', path: '/images/characters/Guerreros/Peon/chaos.png', category: 'Guerreros Z' },
        { name: 'Gohan Niño', path: '/images/characters/Guerreros/Peon/gohan_niño.png', category: 'Guerreros Z' },
        { name: 'Krillin', path: '/images/characters/Guerreros/Peon/krilin.png', category: 'Guerreros Z' },
        { name: 'Pan', path: '/images/characters/Guerreros/Peon/pan.png', category: 'Guerreros Z' },
        { name: 'Roshi', path: '/images/characters/Guerreros/Peon/roshi.png', category: 'Guerreros Z' },
        { name: 'Mr. Satan', path: '/images/characters/Guerreros/Peon/satan.png', category: 'Guerreros Z' },
        { name: 'Videl', path: '/images/characters/Guerreros/Peon/videl.png', category: 'Guerreros Z' },
        { name: 'Bulma', path: '/images/characters/Guerreros/Reina/Bulma.png', category: 'Guerreros Z' },
        { name: 'Daishinkan', path: '/images/characters/Guerreros/Reina/daishinkan.png', category: 'Guerreros Z' },
        { name: 'Gogeta', path: '/images/characters/Guerreros/Reina/gogetta.png', category: 'Guerreros Z' },
        { name: 'Goku UI', path: '/images/characters/Guerreros/Reina/goku_ui.png', category: 'Guerreros Z' },
        { name: 'Vegetto', path: '/images/characters/Guerreros/Reina/vegetto.png', category: 'Guerreros Z' },
        { name: 'Whis', path: '/images/characters/Guerreros/Reina/whiss.png', category: 'Guerreros Z' },
        { name: 'Bills', path: '/images/characters/Guerreros/Rey/Bills.png', category: 'Guerreros Z' },
        { name: 'Kami Sama', path: '/images/characters/Guerreros/Rey/kami.png', category: 'Guerreros Z' },
        { name: 'Karim', path: '/images/characters/Guerreros/Rey/karim.png', category: 'Guerreros Z' },
        { name: 'Zen-Oh', path: '/images/characters/Guerreros/Rey/zen.png', category: 'Guerreros Z' },
        { name: 'Gohan Adolescente', path: '/images/characters/Guerreros/Torre/gohan_adolescente.png', category: 'Guerreros Z' },
        { name: 'Goku', path: '/images/characters/Guerreros/Torre/Goku.png', category: 'Guerreros Z' },
        { name: 'Goku SS1', path: '/images/characters/Guerreros/Torre/gokuss1.png', category: 'Guerreros Z' },
        { name: 'Goku SS2', path: '/images/characters/Guerreros/Torre/gokuss2.png', category: 'Guerreros Z' },
        { name: 'Piccolo', path: '/images/characters/Guerreros/Torre/piccolo.png', category: 'Guerreros Z' },
        { name: 'Popo', path: '/images/characters/Guerreros/Torre/popo.png', category: 'Guerreros Z' },
        { name: 'Yajirobe', path: '/images/characters/Guerreros/Torre/yajirobe.png', category: 'Guerreros Z' },
    ];
